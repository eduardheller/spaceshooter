...
def addText():
    return OnscreenText( style=1, fg=(1,1,1,1), font = font,
...
txtline1 = "MISSION 1: THIS IS THE BEGINNING " #Nur den String aendern
...
def getEnemies(pcount):
    ...
    if wave[0] >= 1 and wave[0]<4:
        enemies=[100,800,"white"]
        wave[0] +=1
        
    elif wave[1] >= 1 and wave[1]<4:
        enemies=[10,800,"white"]    
        wave[1] +=1
